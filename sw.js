...
const CACHE_NAME = 'arcade-shell-v129';
const SHELL_ASSETS = [
    './',
    './index.html',
    './play.html',
    ...
    './js/profile-pet-anim.js',
    './js/accent-extract.js',
    './js/site-branding.js',
    './js/branding-admin.js',
    './js/konami.js',
    './js/profile-minigame.js',
    './js/keybindings.js',
    './js/badges-admin.js',
    './js/customgames.js',
    './js/customgames-admin.js',
    './js/save-queue.js',
    './js/save-editor.js',
    './js/save-editor-gen3.js',
    './js/save-editor-gen4.js',
    './js/save-editor-gen5.js',
    './save-editor.html',
    './games/save-editor-pokedata.json',
    './status.html',
    './sitemap.xml',
    './coop.html',
    './js/patchnotes.js',
